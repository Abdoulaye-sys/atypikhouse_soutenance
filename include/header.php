<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="top-contact float-right">
								...
								| </li>
								<li><i class="fas fa-user-plus text-success mr-1"></i><a href="register.php"> S'inscrire</li><?php } ?>
								</ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/atypikhouse-logos_black.jpg" alt="logo"></a>
